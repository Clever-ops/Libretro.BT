...
enum event_command
{
   ...
   CMD_EVENT_LOAD_STATE_SLOT0,
   CMD_EVENT_LOAD_STATE_SLOT1,
   CMD_EVENT_LOAD_STATE_SLOT2,
   CMD_EVENT_LOAD_STATE_SLOT3,
   CMD_EVENT_LOAD_STATE_SLOT4,
   CMD_EVENT_LOAD_STATE_SLOT5,
   CMD_EVENT_LOAD_STATE_SLOT6,
   CMD_EVENT_LOAD_STATE_SLOT7,
   CMD_EVENT_LOAD_STATE_SLOT8,
   CMD_EVENT_LOAD_STATE_SLOT9,
   ...
   CMD_EVENT_SAVE_STATE_SLOT0,
   CMD_EVENT_SAVE_STATE_SLOT1,
   CMD_EVENT_SAVE_STATE_SLOT2,
   CMD_EVENT_SAVE_STATE_SLOT3,
   CMD_EVENT_SAVE_STATE_SLOT4,
   CMD_EVENT_SAVE_STATE_SLOT5,
   CMD_EVENT_SAVE_STATE_SLOT6,
   CMD_EVENT_SAVE_STATE_SLOT7,
   CMD_EVENT_SAVE_STATE_SLOT8,
   CMD_EVENT_SAVE_STATE_SLOT9,
